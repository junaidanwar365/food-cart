...
<section class="shopping-cart">
   ...
   <table>
      ...
      <tr >
         ...
         confirm('remove item form cart?')"class="delete-btn"><i class="fas fa-trash"></i>Remove</a></td>
      </tr>
          <?php 
          ...
          ?>
      <tr >
        <td><a href="products.php"class="option-btn" style="margin-top: 0;">Countinue Shopping</a></td>
        <td colspan="3">Grand Total</td>
        <td>$<?php echo $grand_total; ?>/-</td>
        <td><a href="cart.php?delete_all"onclick="return confirm('r you sure you want to delete all?')"
